...
<body>
    <div class="vtgrid">
        ...
        <div class="vcontent">
            <iframe src="http://localhost/humanity/views/volunteer/vsidebar-home.php" width="100%" height="100%" scrolling="no"></iframe>
            <iframe src="http://localhost/humanity/views/volunteer/vbg.php" width="100%" height="100%"></iframe>
        </div>
