...
(2, 'BUYHB002', NULL, 'S.M. Chandrasekara', '892450190V', 'Hambantota', 'ahmdodampe@hotmail.com', '0112444786', 'Misbehave', 1);
...
(6, 50, 'Charity', '0000-00-00', 11),
(7, 50, 'Charity', '0000-00-00', 1);
...
(1, 'DONHB001', 11, 'A.P. Nishshanka', '986250470V', '0112555288', 1050, 'manuli1998@gmail.com', 'Colombo', NULL, NULL),
(2, 'DONHB002', 18, 'A.K.Perera', '926130470V', '0112555124', 4000, 'merce177x@gmail.com', 'Malabe', NULL, NULL),
(3, 'DONHB003', NULL, 'M.C. Withana', '821250460V', '0112534877', 0, 'anjana.malitha@gmail.com', 'Galle', 'Misbehave', 1),
(4, 'DONHB004', NULL, 'I.P. Somarathna', '856450470V', '0112555276', 0, 'uthpalakasun@1997gmail.com', 'Colombo', 'Misbehave', 1),
(11, 'DONHB011', 32, 'Dulitha Fernando', '692451124V', '0779985565', 50, 'ahmdodampe@hotmail.com', 'Null', NULL, NULL);
...
(20, 'STFHB004', 'S.E. Perera', 4, 'TMPSTFHB004', '072694', 'VACTHB007', 'Tree planting campaign', '2021-03-31 12:13:01', 'active', NULL);
...
(4, 'STFHB004', 8, 'S.E. Perera', '792345786V', 'Hambantota', '1979-11-03', 'ahmdodampe@hotmail.com', 'male', '2018-10-13', '0712894451', 4, 'accepted', 0, 0, NULL),
(5, 'STFHB005', NULL, 'T.P. Fernando', '787223621V', 'Hambanotota', '1978-11-10', 'anjana.malitha@gmail.com', 'male ', '2018-11-03', '0112333221', 1, 'deleted', 0, 0, 'Misbehave'),
(6, 'STFHB006', 10, 'F.R. Wijenayaka', '892345786V', 'Hambantota', '1989-07-20', 'vigaravi98@gmail.com', 'female', '2019-10-13', '0712894451', 1, 'accepted', 4, 0, NULL),
...
(32, 'dulitha_f', '$2y$10$Iox/iJXdA6LuSbAhCpEyXOVAqwbf2eY3CeIxP.gPFVl8ihaTogUyi', 'donor');
...
INSERT INTO `volunteer` (`id`, `vol_id`, `userlogin_id`, `name`, `nic`, `address`, `gender`, `dob`, `email`, `contact`, `level`, `vol_points`, `prev_vol_exp`, `join_date`, `status`, `reject_reason`, `remove_reson`) VALUES
(1, 'VOLHB001', 13, 'A.C. Wikramasinghe', '887250470V', 'Hambantota', 'male ', '1988-11-11', 'manuli1998@gmail.com', '0112555287', 'Permanent Volunteer', 100, 'University Volunteering', '2020-12-01 13:07:53', 1, NULL, NULL),
(14, 'VOLHB014', NULL, 'Anjana Malitha', '965284752V', 'Bandagiriya, Hambantota', 'male ', '2000-02-02', 'ahmdodampe@hotmail.com', '0779985565', 'Temporary Volunteer', 0, 'No Prior Experience', '2021-03-31 11:43:29', 1, NULL, 'Misbehave');
...
(6, 'VACTHB006', 'Food Distribution Campaign', 10, 'Hambantota Town', '2020-12-25 09:00:00', '2020-11-25 13:30:00', 300, 300, 4, 0),
(7, 'VACTHB007', 'Tree planting campaign', 10, 'Matara', '2020-12-05 13:57:00', '2020-12-05 18:57:00', 200, 0, 1, 0),
(8, 'VACTHB008', 'Tree Planting in Sinharaja', 0, 'Sinharaja', '2021-04-01 04:21:00', '2021-04-03 14:24:00', 200, 0, 1, 1);
...
--
ALTER TABLE `donor`
  ADD CONSTRAINT `dell_com_ibfk_2` FOREIGN KEY (`del_com`) REFERENCES `commissioner` (`id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `donor_ibfk_1` FOREIGN KEY (`userlogin_id`) REFERENCES `user` (`id`) ON DELETE SET NULL;
