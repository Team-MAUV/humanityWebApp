...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2021 at 12:16 PM
...
INSERT INTO `beneficiery_case` (`id`, `beneficiery_id`, `vol_id`, `com_id`, `start_date`, `closed_date`, `case_path`, `status`, `approval`, `reject_reason`) VALUES
(1, 'BCASEHB001', 1, 2, '2019-06-07', '2019-07-07', 'beneficiery_case/Group Project I - Proposal Evaluation Criteria Grid.pdf', 'finished', 'approve', NULL),
(2, 'BCASEHB002', 2, 3, '2020-06-07', NULL, 'beneficiery_case/Second Year Group Project Guide 2020.pdf', 'current', 'approve', NULL),
(4, 'BCASEHB004', 3, 2, '2019-06-07', NULL, 'beneficiery_case/harry-potter-and-the-prisoner-of-azkaban-yify-english.srt', 'current', 'approve', NULL),
(5, 'BCASEHB005', 1, 1, '2021-03-31', NULL, 'beneficiery_case/harry-potter-and-the-order-of-the-phoenix-yify-english.srt', 'reject', 'rejected', 'insufficient details'),
(6, 'BCASEHB006', 4, NULL, '2021-03-30', NULL, 'beneficiery_case/harry-potter-and-the-half-blood-prince-yify-english.srt', 'pending', NULL, NULL),
(7, 'BCASEHB007', 1, NULL, '2021-03-30', NULL, 'beneficiery_case/harry-potter-and-the-deathly-hallows-part-2-yify-english.srt', 'pending', NULL, NULL),
(8, 'BCASEHB008', 1, 1, '2021-03-30', NULL, 'beneficiery_case/SCS2209 Database II.docx', 'pending', NULL, NULL),
(9, 'BCASEHB009', 2, NULL, '2021-03-30', NULL, 'beneficiery_case/Lecture - Week 06.pdf', 'pending', NULL, NULL),
(10, 'BCASEHB010', 3, 1, '2021-03-30', NULL, 'beneficiery_case/Syllabus.doc', 'current', 'approve', NULL);
...
CREATE TABLE `buyer` (
  ...
  `remove_reson` varchar(500) DEFAULT NULL,
  `del_com` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `buyer` (`id`, `buy_id`, `userlogin_id`, `name`, `nic`, `address`, `email`, `contact`, `remove_reson`, `del_com`) VALUES
(1, 'BUYHB001', 12, 'S.D. Sarada', '896450470V', 'Malabe', 'vigaravi98@gmail.com', '0112888456', NULL, NULL),
(2, 'BUYHB002', 19, 'S.M. Chandrasekara', '892450190V', 'Hambantota', 'ahmdodampe@hotmail.com', '0112444786', NULL, NULL);
...
INSERT INTO `donor` (`id`, `don_id`, `userlogin_id`, `name`, `nic`, `contact`, `contribution`, `email`, `address`, `remove_reson`, `del_com`) VALUES
(1, 'DONHB001', 11, 'A.P. Nishshanka', '986250470V', '0112555288', 1000, 'manuli1998@gmail.com', 'Colombo', NULL, NULL),
(2, 'DONHB002', 18, 'A.K.Perera', '926130470V', '0112555124', 4000, 'merce177x@gmail.com', 'Malabe', NULL, NULL),
(3, 'DONHB003', 20, 'M.C. Withana', '821250460V', '0112534877', 0, 'anjana.malitha@gmail.com', 'Galle', NULL, NULL),
(4, 'DONHB004', 24, 'I.P. Somarathna', '856450470V', '0112555276', 0, 'uthpalakasun@1997gmail.com', 'Colombo', NULL, NULL);
...
INSERT INTO `marking_attendance` (`incharge_id`, `activity_id`, `vol_id`, `date`, `confirm`, `attendance`) VALUES
(2, 1, 1, '2021-03-17', 1, 1),
(18, 2, 1, '2021-01-10', 0, 0);
...
(12, 'PROHB012', 'test 333', 0, 'Electronic', 1, '2021-03-25 16:59:00', '2021-03-26 16:59:00', 1, 40003, 0, 'test ', 40000, 'product_images/abandoned-building.jpg', 200),
...
(17, 'PROHB017', 'test 332', 0, 'Plastic', 1, '2021-03-18 11:21:00', '2021-03-18 11:22:00', NULL, 0, 0, 'efcaffdssdsaddsd', 22222, 'product_images/account_circle_24px.png', 22);
...
(2, 'RPTHB002', 'Annual Market Report', 1, '2020-06-08', NULL, 'rejected', '', 1, 'project_report/Database II Transaction (Tutorial 03).pdf'),
...
(16, 'STFHB006', 'F.R. Wijenayaka', 6, 'TMPSTFHB006', '342178', '', 'Tree planting campaign', '2021-03-21 18:49:09', 'closed', '2021-03-30 05:23:40'),
...
INSERT INTO `staff` (`id`, `staff_id`, `userlogin_id`, `name`, `nic`, `address`, `dob`, `email`, `gender`, `joined_year`, `contact`, `com_id`, `status`, `no_leave`, `availability`, `remove_reson`) VALUES
(1, 'STFHB001', 5, 'A.S. Nimali', '916289470V', 'Hambantota', '1991-02-12', 'manuli1998@gmail.com', 'female ', '2016-10-13', '0112333211', 1, 'accepted', 5, 0, NULL),
(2, 'STFHB002', 6, 'H.J. Amal', '832345786V', 'Hambantota', '1983-11-04', 'thavinu2003@gmail.com', 'male', '2017-11-03', '0712894523', 3, 'accepted', 2, 0, NULL),
(3, 'STFHB003', 7, 'D.R. Amasha', '667223621V', 'Hambantota', '1966-06-22', 'vigaucsc2019@gmail.com', 'female ', '2017-12-15', '0112333456', 2, 'accepted', 1, 0, NULL),
(4, 'STFHB004', 8, 'S.E. Perera', '792345786V', 'Hambantota', '1979-11-03', 'ahmdodampe@hotmail.com', 'male', '2018-10-13', '0712894451', 4, 'accepted', 0, 1, NULL),
(5, 'STFHB005', 9, 'T.P. Fernando', '787223621V', 'Hambanotota', '1978-11-10', 'anjana.malitha@gmail.com', 'male ', '2018-11-03', '0112333221', 2, 'accepted', 0, 0, NULL),
(6, 'STFHB006', 10, 'F.R. Wijenayaka', '892345786V', 'Hambantota', '1989-07-20', 'vigaravi98@gmail.com', 'female', '2019-10-13', '0712894451', 1, 'accepted', 4, 1, NULL),
(7, 'STFHB007', NULL, 'S.K. Ranasinghe', '637223621V', 'Hambanota', '1963-11-25', 'merce177x@gmail.com', 'female ', '2020-11-30', '0112333228', NULL, 'pending', 0, 1, NULL);
...
INSERT INTO `volunteer` (`id`, `vol_id`, `userlogin_id`, `name`, `nic`, `address`, `gender`, `dob`, `email`, `contact`, `level`, `vol_points`, `prev_vol_exp`, `join_date`, `status`, `reject_reason`) VALUES
(1, 'VOLHB001', 13, 'A.C. Wikramasinghe', '887250470V', 'Hambantota', 'male ', '1988-11-11', 'manuli1998@gmail.com', '0112555287', 'Permanent Volunteer', 100, 'University Volunteering', '2020-12-01 13:07:53', 1, NULL),
(2, 'VOLHB002', 14, 'J.K. Edirisinghe', '892450470V', 'Malabe', 'female ', '1989-07-13', 'edirisinghe@hotmail.com', '0112555121', 'Permanent Volunteer', 200, 'Nothing', '2020-12-01 09:10:53', 1, NULL),
(3, 'VOLHB003', 15, 'F.A. Silva', '816450470V', 'Hambantota', 'male ', '1981-11-25', 'silva@gmail.com', '0112888456', 'Temporary Volunteer', 0, 'Nothing', '2020-11-19 10:05:57', 1, NULL),
(4, 'VOLHB004', 16, 'A.R. Thisera', '926450490V', 'Hambantota', 'female ', '1992-03-23', 'vigaravi98@gmail.com', '0112555221', 'Temporary Volunteer', 0, 'Nothing', '2020-11-19 10:07:13', 1, NULL),
(5, 'VOLHB005', 17, 'S.W. Bandara', '946310490V', 'Hambantota', 'female ', '1994-12-02', 'uthpalakasun1997@gmail.com', '0112566459', 'Temporary Volunteer', 0, 'Nothing', '2020-12-02 04:45:05', 1, NULL),
(6, NULL, NULL, 'H.R. Ramasha', '936253470V', 'Colombo', 'male ', '1993-09-21', 'anjana.malitha@gmail.com', '0762355287', NULL, NULL, 'Nothing', '2020-12-01 16:45:44', 0, NULL),
(7, NULL, NULL, ' J.L. Perera', '886230470V', 'Hambantota', 'female ', '1988-02-12', 'thavinu2003@gmail.com', '0112555222', NULL, NULL, 'Nothing', '2020-12-01 16:46:00', 0, NULL),
(8, 'VOLHB008', 26, 'A.M. Dodampe', '966250470V', 'Hambantota', 'male ', '1996-12-09', 'ahmdodampe@hotmail.com', '0112555124', 'Temporary Volunteer', 0, 'Nothing', '2020-12-01 16:46:44', 1, NULL),
(9, 'VOLHB009', 27, 'M.C.Wanniarachichi', '987250470V', 'Colombo', 'female ', '1998-12-22', 'merce177x@gmail.com', '0718077941', 'Temporary Volunteer', 0, 'Nothing', '2020-12-02 09:59:42', 1, NULL),
(10, NULL, NULL, 'C.D. Perera', '721256467V', 'Hambantota', 'male ', '1972-03-07', 'thamaraathu@gmail.com', '0764752000', NULL, NULL, 'Nothing', '2021-03-25 17:58:31', 0, NULL);
...
(2, 'VACTHB002', 'Blood Donation Campaign', 10, 'Community Hall', '2021-05-10 10:00:00', '2021-05-10 16:00:34', 300, 231, 3, 0),
...
ALTER TABLE `actimage`
  ...
  ADD KEY `fk_inch_id` (`incharge_id`);
...
ALTER TABLE `buyer`
  ...
  ADD KEY `del_com_ibfk_2` (`del_com`);
...
ALTER TABLE `donor`
  ...
  ADD KEY `userlogin_id` (`userlogin_id`),
  ADD KEY `dell_com_ibfk_2` (`del_com`);
...
ALTER TABLE `marking_attendance`
  ADD PRIMARY KEY (`incharge_id`,`activity_id`,`vol_id`) USING BTREE,
  ADD KEY `vol_id` (`vol_id`),
  ADD KEY `activity_id` (`activity_id`);
...
--
-- Constraints for table `actimage`
--
ALTER TABLE `actimage`
  ADD CONSTRAINT `fk_act_id` FOREIGN KEY (`act_id`) REFERENCES `vol_activity` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_inch_id` FOREIGN KEY (`incharge_id`) REFERENCES `session_incharge` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `buyer`
  ADD CONSTRAINT `buyer_ibfk_1` FOREIGN KEY (`userlogin_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `del_com_ibfk_2` FOREIGN KEY (`del_com`) REFERENCES `commissioner` (`id`) ON DELETE NO ACTION;
...
--
ALTER TABLE `donor`
  ADD CONSTRAINT `dell_com_ibfk_2` FOREIGN KEY (`del_com`) REFERENCES `commissioner` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `donor_ibfk_1` FOREIGN KEY (`userlogin_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION;
...
--
ALTER TABLE `staff`
  ADD CONSTRAINT `staff_ibfk_2` FOREIGN KEY (`com_id`) REFERENCES `commissioner` (`id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `staff_ibfk_3` FOREIGN KEY (`userlogin_id`) REFERENCES `user` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `volunteer`
--
ALTER TABLE `volunteer`
  ADD CONSTRAINT `volunteer_ibfk_1` FOREIGN KEY (`userlogin_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
